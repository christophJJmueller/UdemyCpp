...
//Template-Klasse muss in Header-Datei deklariert UND definiert werden!
...
public:
    ...
    //Addition und Subtraktion -> Operatoren definieren (+, -)
    Matrix operator+(const Matrix &rhs) const; //rhs = right hand side
